...
export function About() {
  ...
  return (
    <section
      id="about"
      className="py-24 bg-white dark:bg-zinc-900 transition-colors duration-300"
    >
              ...
              <div className="bg-zinc-50 dark:bg-zinc-950 p-6 rounded-2xl border border-zinc-100 dark:border-zinc-800 transition-colors duration-300">
                ...
                <div className="flex flex-wrap gap-2">
                  {mergedSkills.map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1.5 bg-white dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300 rounded-md text-sm font-medium border border-zinc-200 dark:border-zinc-700 hover:border-emerald-300 dark:hover:border-emerald-500 transition-colors shadow-sm"
                    >
                      {skill}
                    </span>
                  ))}
              ...
              <div className="bg-emerald-50/50 dark:bg-emerald-900/10 p-6 rounded-2xl border border-emerald-100 dark:border-emerald-900/30 transition-colors duration-300">
                ...
                <div className="flex flex-wrap gap-2">
                  {aiTools.map((tool) => (
                    <span
                      key={tool}
                      className="px-3 py-1.5 bg-white dark:bg-zinc-900 text-emerald-800 dark:text-emerald-400 rounded-md text-sm font-medium border border-emerald-200 dark:border-emerald-800 hover:border-emerald-400 dark:hover:border-emerald-600 transition-colors shadow-sm"
                    >
                      {tool}
                    </span>
                  ))}
